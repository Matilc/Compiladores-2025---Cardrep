...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 27:
			case_27:
			if (ch == L'U') {AddCh(); goto case_28;}
			else {goto case_0;}
		case 28:
			case_28:
			if (ch == L'G') {AddCh(); goto case_29;}
			else {goto case_0;}
		case 29:
			case_29:
			if (ch == L'A') {AddCh(); goto case_30;}
			else {goto case_0;}
		case 30:
			case_30:
			if (ch == L'D') {AddCh(); goto case_31;}
			else {goto case_0;}
		case 31:
			case_31:
			if (ch == L'O') {AddCh(); goto case_32;}
			else {goto case_0;}
		case 32:
			case_32:
		...
		case 34:
			case_34:
			if (ch == L'P') {AddCh(); goto case_35;}
			else {goto case_0;}
		case 35:
			case_35:
			if (ch == L'O') {AddCh(); goto case_36;}
			else {goto case_0;}
		case 36:
			case_36:
		...
		case 53:
			...
			else if (ch == L'M') {AddCh(); goto case_55;}
			else {goto case_0;}
		case 54:
			case_54:
			recEnd = pos; recKind = 1;
		...
		case 57:
			case_57:
			if (ch == L'S') {AddCh(); goto case_59;}
			else {goto case_0;}
		case 58:
			case_58:
			recEnd = pos; recKind = 1;
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'A' && ch <= L'Z') || (ch >= L'a' && ch <= L'z')) {AddCh(); goto case_1;}
			else if (ch == L'_') {AddCh(); goto case_60;}
			else {t->kind = 1; wchar_t *literal = coco_string_create(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 59:
			case_59:
			if (ch == L'A') {AddCh(); goto case_61;}
			else {goto case_0;}
		case 60:
			case_60:
		...
		case 61:
			case_61:
			if (ch == L'_') {AddCh(); goto case_62;}
			else {goto case_0;}
		case 62:
			case_62:
			if (ch == L'J') {AddCh(); goto case_27;}
			else if (ch == L'O') {AddCh(); goto case_34;}
			else {goto case_0;}
