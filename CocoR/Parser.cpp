...
void Parser::Estado() {
		Expect(6 /* "MANO_JUGADOR" */);
		Expect(7 /* "[" */);
		ListaCartas();
		Expect(8 /* "]" */);
		Expect(9 /* "MANO_DEALER" */);
		Expect(7 /* "[" */);
		ListaCartas();
		Expect(8 /* "]" */);
}

void Parser::ListaCartas() {
		Carta();
		while (la->kind == 10 /* "," */) {
			Get();
			Carta();
...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 6: s = coco_string_create(L"\"MANO_JUGADOR\" expected"); break;
			case 7: s = coco_string_create(L"\"[\" expected"); break;
			case 8: s = coco_string_create(L"\"]\" expected"); break;
			case 9: s = coco_string_create(L"\"MANO_DEALER\" expected"); break;
			case 10: s = coco_string_create(L"\",\" expected"); break;
			case 11: s = coco_string_create(L"\"_\" expected"); break;
			case 12: s = coco_string_create(L"??? expected"); break;
			case 13: s = coco_string_create(L"invalid ValorCarta"); break;
